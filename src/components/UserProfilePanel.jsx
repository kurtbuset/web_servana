...
export default function UserProfilePanel({ userData, isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* Slide-in Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-96 shadow-2xl z-[70] transform transition-transform duration-300 ease-out ${
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[80] p-4 sm:p-6 animate-fadeIn">
          <div 
