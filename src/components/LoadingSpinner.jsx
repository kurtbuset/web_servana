...
const LoadingSpinner = ({
  ...
  const spinner = (
    <div
      className={`animate-spin rounded-full border-2 border-t-[#6237A0] ${sizeClasses[size]}`}
      ...
      >
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <div
              className="animate-spin rounded-full h-12 w-12 border-3 border-t-[#6237A0]"
              style={{
                borderColor: "var(--border-color)",
                borderTopColor: "#6237A0",
              }}
            ></div>
          </div>
          <div className="mb-2">
            ...
            >
              <text
                ...
                style={{ fill: isDark ? "#f5f5f5" : "#6237A0" }}
              >
                Servana
              </text>
            </svg>
