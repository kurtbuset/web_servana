 ...
 * @param {boolean} canViewAnalyticsManageAgents - Permission to view analytics
 * @param {boolean} isDark - Dark mode flag
 */
export default function AnalyticsView({ agent, onBack, canViewAnalyticsManageAgents, isDark }) {
  return (
    <ScrollContainer className="flex-1 pb-4">
      ...
      {canViewAnalyticsManageAgents ? (
        ...
        <div className="p-8 text-center">
          <div className="mb-4">
            <svg className="w-16 h-16 mx-auto" style={{ color: 'var(--text-secondary)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
            You don't have permission to view agent analytics and performance data.
          </p>
        </div>
      )}
    </ScrollContainer>
