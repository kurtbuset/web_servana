        ...
        <div className="flex flex-1 overflow-hidden">
          <div className="flex-1 p-2 overflow-hidden">
                ...
                {loading ? (
                  <div className="flex items-center justify-center h-full">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-xs" style={{ color: 'var(--text-secondary)' }}>Loading client macros...</span>
                    </div>
                  </div>
                ) : error ? (
                  <div className="flex items-center justify-center h-full">
            ...
            <Modal
              ...
              title={currentEditId ? 'Edit Macro' : 'Add Macro'}
              isDark={isDark}
              actions={[
                {
                  label: 'Cancel',
                ...
                {
                  label: currentEditId ? 'Save Changes' : 'Create Macro',
