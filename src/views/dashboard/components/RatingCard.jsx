...
export default function RatingCard({
  ...
  const rating =
    dashboardStats?.satisfaction?.averageRating ||
    customerSatisfaction?.averageRating ||
    0;
  const totalReviews =
    dashboardStats?.satisfaction?.totalRatings ||
    customerSatisfaction?.totalRatings ||
    0;
  ...
  useEffect(() => {
    const debugData = {
      ...
      totalReviews,
      ratingDistribution,
      customerSatisfactionKeys: customerSatisfaction
        ? Object.keys(customerSatisfaction)
        : [],
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center h-32 text-center">
          ...
          <details
            style={{ marginTop: "8px", fontSize: "8px", color: "var(--muted)" }}
          >
  ...
  return (
    ...
    >
          ...
          >
            {[5, 4, 3, 2, 1].map((starLevel) => {
              ...
              return (
                ...
                >
                  <span style={{ minWidth: "8px", fontWeight: "500" }}>
                    {starLevel}
                  </span>
                  <div
                    style={{
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: "100%",
                        background:
                          percentage > 0 ? "var(--gold)" : "transparent",
                        borderRadius: "3px",
      ...
      >
        Based on{" "}
        <strong style={{ color: "var(--text)" }}>{totalReviews}</strong>{" "}
        {totalReviews === 1 ? "review" : "reviews"} {formatPeriodLabel()}
      </div>
    </div>
  );
}
