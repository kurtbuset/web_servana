 ...
 */
const QuickActions = memo(function QuickActions({ navigate, hasPermission, className }) {
    return (
        <div className={`${className || ''} rounded-lg p-4 shadow-sm border`} 
            ...
            <div className="space-y-2">
                ...
                >
                    ...
                    <span className="text-xs font-medium" style={{ color: 'var(--text-primary)' }}>View Queue</span>
                </button>
            </div>
        </div>
    );
