...
class TokenService {
  ...
  async refreshToken() {
    ...
    try {
      // Browser sends refresh_token cookie automatically via withCredentials on api instance
  ...
  handleSessionExpired() {
    ...
    // Backend clears cookies on logout; just clear the in-memory access token
