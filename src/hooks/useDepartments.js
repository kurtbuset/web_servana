...
export const useDepartments = () => {
  ...
  const fetchDepartments = useCallback(async () => {
    ...
    try {
      ...
      const errorMessage =
        err.response?.data?.error || "Failed to fetch departments";
  ...
  const toggleDepartment = useCallback(
    async (deptId, currentStatus) => {
      ...
      try {
        ...
        const errorMessage =
          err.response?.data?.error || "Failed to toggle active status";
